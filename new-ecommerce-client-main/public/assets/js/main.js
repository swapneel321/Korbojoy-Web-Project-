(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(".category-list-close").on("click", function () {
      ...
      setTimeout(() => {
        $(".banner .category-list").hasClass("d-none")
          ? ""
          : $(".banner .category-list").removeClass("d-none");
      }, 5000);
      $(".banner .category-list").hasClass("d-none")
    ...
    $(".category-list ul li.has-sub, .category-list-2 ul li.has-sub")
    ...
    $(".mobile-category-list ul li.has-sub")
      .append("<span class='plus'><i class='fa-regular fa-plus'></i></span>")
      .children("a")
      .removeAttr("href")
      .attr("role", "button");
    $(".mobile-category-list .category-item.has-sub a").on(
      "click",
      function () {
    ...
    $(".product-slider-1").slick({
      ...
      prevArrow:
        '<button type="button" class="slick-prev"><i class="fa-solid fa-angle-up"></i></button>',
      nextArrow:
        '<button type="button" class="slick-next"><i class="fa-solid fa-angle-down"></i></button>',
      autoplay: true,
      pauseOnFocus: false,
      pauseOnHover: false,
      responsive: [
    ...
    $("#prevImg").on("click", function () {
      if ($(".small-thumb.active").prev().is(".small-thumb")) {
        var prevImg = $(".small-thumb.active")
          .prev(".small-thumb")
          .find("img")
          .attr("src");
        $(".small-thumb.active")
    ...
    $("#nextImg").on("click", function () {
      if ($(".small-thumb.active").next().is(".small-thumb")) {
        var nextImg = $(".small-thumb.active")
          .next(".small-thumb")
          .find("img")
          .attr("src");
        $(".small-thumb.active")
