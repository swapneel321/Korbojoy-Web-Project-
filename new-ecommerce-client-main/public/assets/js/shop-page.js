(function ($) {
  ...
  $(document).ready(function () {
    ...
    $("#listView").on("click", function () {
      ...
      $(".product-col")
        .removeClass("col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6")
        .addClass("col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12")
        .find(".single-product-card")
    ...
    $("#gridView").on("click", function () {
      $(this).addClass("active").siblings().removeClass("active");
      $(".product-col")
        .addClass("col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6")
        .removeClass(
          "col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"
        )
        .find(".single-product-card")
        .removeClass("product-card-list");
