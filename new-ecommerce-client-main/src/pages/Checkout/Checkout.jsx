          ...
          <div className="row">
            <div className="col-12">
              <div className="tab-nav">
                ...
                <button className="single-nav" data-tab="checkOutTab">
                  <Link to={"/checkout"}>
              ...
              <div className="tab-contents">
                <div className="single-tab active" id="checkOutTab">
                  <div className="row">
                          ...
                          <ul>
                            <li>
                              ...
                              <span className="price-txt">
                                $<span className="sub-total-2">{price}</span>
                              </span>
                            </li>
                            <li>
                              Shipping{" "}
                            ...
                            <li>
                              Vat{" "}
                              <span className="price-txt" id="shippingFee2">
                                <span className="text-success">{vat}</span>
                              </span>
                            </li>
                            <li className="total-price-wrap">
                              Total{" "}
                              <span className="price-txt">
                                $<span id="totalPrice2">{grandPrice}</span>
                              </span>
                            </li>
                          </ul>
                        </div>
