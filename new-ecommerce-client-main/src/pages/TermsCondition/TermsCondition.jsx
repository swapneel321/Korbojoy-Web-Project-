...
function TermsCondition() {
  ...
  return (
    <div>
      <div className="page-content" style={{ margin: "120px 0" }}>
        <div className="container">
          <section className="introduce mb-10 pb-10">
            <h2 className=" mx-auto text-center">Terms & ConditionKorbo Joy</h2>
            <p>
              These terms and conditions outline the rules and regulations for
              the use of Korbo Joy's Website, located at korbojoy.com.
            </p>
            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use korbojoy if you do not agree to
            ...
            <h6>Cookies</h6>
            <p>
              We employ the use of cookies. By accessing korbojoy, you agreed to
              use cookies in agreement with Korbo Joy's Privacy Policy.
            </p>
            <p>
            ...
            <h6>License</h6>
            <p>
              Unless otherwise stated, Korbo Joy and/or its licensors own the
              intellectual property rights for all material on korbojoy. All
              intellectual property rights are reserved. You may access this
              from korbojoy for your own personal use subjected to restrictions
              set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <li>Republish material from korbojoy</li>
            <li>Sell, rent, or sub-license material from korbojoy</li>
            <li>Reproduce, duplicate or copy material from korbojoy</li>
            <li>Redistribute content from korbojoy</li>
            ...
            <p>
              ...
              Korbo Joy does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of Korbo Joy, its agents, and/or affiliates.
              ...
              laws, Korbo Joy shall not be liable for the Comments or for any
            ...
            <p>
              Korbo Joy reserves the right to monitor all Comments and to remove
            ...
            <p>
              You hereby grant Korbo Joy a non-exclusive license to use,
            ...
            <p>
              ...
              compensates the absence of Korbo Joy, and{" "}
            </p>
            <p>
            ...
            <p>
              ...
              by sending an e-mail to Korbo Joy. Please include your name, your
            ...
            <p>
              No use of Korbo Joy's logo or other artwork will be allowed for
